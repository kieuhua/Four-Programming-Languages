       ...
       // Poker pk = new Poker("3S 2H AC 2D 4H");
        ...
        for (int i=1; i< hands.length; i++) {
            ...
            if ( comparePokerResult(currentScore, bestScore) > 0 ){
                ...
                //bestHand = hands[i];
                bestHand = currentHand;
            } else if ( comparePokerResult(currentScore, bestScore) == 0 ){
            	String[] bestHand2 = new String[2];
            	bestHand2[0] = bestHand;
            	bestHand2[1] = currentHand;
            	return bestHand2;
            }
        } 
       // System.out.println(bestHand);   
        String[] bestHand1 = new String[1];
        bestHand1[0] = bestHand;
        return bestHand1;
    }
